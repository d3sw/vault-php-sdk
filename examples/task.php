...
use Codific\Vault\Exception\ServerException;
...
class VaultTask
{
     ...
     * Vault API Factory
     *
     * @var Codific\Vault\ServiceFactory
     */
    protected $factory;
     ...
     *
     * @return Codific\Vault\Services\Sys
     */
    public function sys()
    {
     ...
     *
     * @return Codific\Vault\Services\Data
     */
     ...
     *
     * @return Codific\Vault\ServiceFactory
     */
